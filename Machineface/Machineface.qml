...
ServiceWindow {
    ...
    TabView {
        ...
        GCodeTab { }
        VBC_Tab{id:vbcTab}
        BarcodeTab{id:barcodetab}
        VBCHistory{id:vbcHistory}
        BrushDataTab{id:brushdata}
    ...
    DisplayPanel {
        ...
        visible: {(!signalTab.visible && !barcodetab.visible
                   && !vbcHistory.visible && !brushdata.visible)
        }
    }
